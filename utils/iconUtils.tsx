...
export const getIcon = (icon: Icon): JSX.Element => {
  switch (icon) {
    ...
    case 'topAction':
      return (
        <svg
          style={Object.assign({ width: '1.23em', height: '1.23em' })}
          viewBox='0 0 24 24'>
          <path
            fill='currentColor'
    ...
    case 'shift':
      return (
        <svg
          style={Object.assign({ width: '1em', height: '.916em' })}
          viewBox='0 0 24 21'
          fill='none'
          xmlns='http://www.w3.org/2000/svg'>
          <path
    ...
    case 'backspace':
      return (
        <svg
          style={Object.assign({ width: '1.08em', height: '.916em' })}
          viewBox='0 0 25 20'
          fill='none'
          xmlns='http://www.w3.org/2000/svg'>
          <path
    ...
    case 'return':
      return (
        <svg
          style={Object.assign({ width: '1.66em', height: '1.66em' })}
          viewBox='0 0 34 34'
          fill='none'
          xmlns='http://www.w3.org/2000/svg'>
          <path
