  ...
  return (
    <motion.div
      ...
      <div className='rounded-3xl border border-gray-500 bg-secondaryBackground flex flex-col items-center justify-center overflow-hidden'>
        <div className='object-contain w-16 h-16 md:w-22 md:h-22 xl:w-26 xl:h-26 filter group-hover:blur-[3px] group-hover:grayscale-[.7] transition duration-300 ease-in-out m-4 relative'>
          <Image
            src={skill.imageUrl}
            alt={skill.name}
            width='100'
