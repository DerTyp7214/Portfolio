...
const languageSkills = [
    'Kotlin', 'JavaScript', 'C', 'JSON',
    'HTML', 'CSS', 'Java', 'C++', 'TypeScript'
]

const technologySkills = [
    'ReactJS', 'NodeJS', 'ExpressJS', 'Electron', 'Gson',
]
...
export default async function handler(
    ...
    const skillData = await Promise.all([
        ...languageSkills.map(skill =>
            fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/getSkill/language/${skill}?get_by=username`)
                .then(async res => res.json()) as Promise<Skill>
        ),
        ...technologySkills.map(skill =>
            fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/getSkill/technology/${skill}?get_by=username`)
                .then(async res => res.json()) as Promise<Skill>
        )
    ])

    const getSkills = (skills: string[]) => skillData.filter(a => skills.includes(a.name))

    const projects: Project[] = [
        {
            name: 'Rboard Theme Manager V3',
            authors: ['DerTyp7214', 'AkosPaha', 'RadekBledowski'],
            imageUrl: 'https://raw.githubusercontent.com/DerTyp7214/RboardThemeManagerV3/staging/app/src/main/ic_launcher-playstore.png',
        ...
        },
        {
            ...
            imageUrl: 'https://raw.githubusercontent.com/DerTyp7214/RboardThemeCreator/staging/app/src/main/ic_launcher-playstore.png',
            skills: getSkills(['Kotlin', 'Gson', 'C', 'C++']),
            githubUrl: 'https://github.com/DerTyp7214/RboardThemeCreator',
            playStoreUrl: 'https://play.google.com/store/apps/details?id=de.dertyp7214.rboardthemecreator',
            keypoints: [
        ...
        },
        {
            name: 'Rboard Patcher',
            authors: ['DerTyp7214', 'RadekBledowski'],
            imageUrl: 'https://raw.githubusercontent.com/DerTyp7214/RboardPatcher/staging/app/src/main/ic_launcher-playstore.png',
            skills: getSkills(['Kotlin', 'Gson', 'C', 'C++']),
            githubUrl: 'https://github.com/DerTyp7214/RboardPatcher',
            playStoreUrl: 'https://play.google.com/store/apps/details?id=de.dertyp7214.rboardpatcher',
            keypoints: [
        ...
        },
        {
            ...
            authors: ['DerTyp7214', 'RadekBledowski'],
            imageUrl: 'https://raw.githubusercontent.com/DerTyp7214/RboardIMETester/staging/app/src/main/ic_launcher-playstore.png',
            skills: getSkills(['Kotlin', 'Gson', 'C', 'C++']),
            githubUrl: 'https://github.com/DerTyp7214/RboardIMETester',
            playStoreUrl: 'https://play.google.com/store/apps/details?id=de.dertyp7214.rboardimetester',
            keypoints: [
        ...
        },
        {
            ...
            authors: ['DerTyp7214', 'RadekBledowski'],
            imageUrl: 'https://raw.githubusercontent.com/DerTyp7214/MixplorerThemeCreator/master/app/src/main/ic_launcher-playstore.png',
            skills: getSkills(['Kotlin', 'Gson', 'C', 'C++']),
            githubUrl: 'https://github.com/DerTyp7214/MixplorerThemeCreator',
            playStoreUrl: 'https://play.google.com/store/apps/details?id=de.dertyp7214.mixplorerthemecreator',
            keypoints: [
        ...
        },
        {
            name: 'Overlayer',
            authors: ['DerTyp7214', 'RadekBledowski'],
            imageUrl: 'https://play-lh.googleusercontent.com/uWDZ4vxJ1XEmyiZIri4Jg8o-SwJOMSQWO53sNdt3LmNPXOsKcM36MU9sCU-CnzzPHZcN=w240-h480-rw',
            skills: getSkills(['Kotlin']),
            githubUrl: 'https://github.com/DerTyp7214/Overlayer',
            playStoreUrl: 'https://play.google.com/store/apps/details?id=de.dertyp7214.overlayer',
            keypoints: [
        ...
        },
        {
            ...
            authors: ['DerTyp7214'],
            imageUrl: 'https://raw.githubusercontent.com/DerTyp7214/YouTubeMusicRemote/master/app/src/main/ic_launcher-playstore.png',
            skills: getSkills(['Kotlin', 'Gson']),
            githubUrl: 'https://github.com/DerTyp7214/YouTubeMusicRemote',
            playStoreUrl: 'https://play.google.com/store/apps/details?id=de.dertyp7214.youtubemusicremote',
            keypoints: [
        ...
        },
        {
            ...
            authors: ['DerTyp7214'],
            imageUrl: 'https://raw.githubusercontent.com/DerTyp7214/youtube-music/master/assets/youtube-music.png',
